...
In many instances, non-physical behaviors can arise in the :py:class:`model.ClusterModel` instances generated by CG. This
...
The first thing that all CG users should have a good understanding of is how different non-physicality arise in our models and
...
Type 2 Non-physicalities are gravity theory specific. Due to the modularity of the gravity implementation and the capacity for CG to support arbitrary
